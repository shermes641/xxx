...
/**
  ...
  */
class ReviewAppSeedLoader extends ApplicationLoader {
  def load(context: Context) = {
    val appConfigComponents = new ReviewAppSeedComponents(context)
...
/**
  ...
  */
class ReviewAppSeedComponents(context: Context) extends BuiltInComponentsFromContext(context) with MailerComponents with DBComponents with HikariCPComponents with DeadboltComponents with EhCacheComponents {
