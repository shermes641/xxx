...
/**
  ...
  */
case class UnityAdsCallback(appToken: String, sid: String, oid: String, hmac: String) extends CallbackVerificationHelper with Controller {

  final val algo = "HmacMD5"
  final val BadSigningResult = ""
  final val ValidNumberOfParams = 3
  override val adProviderName = Constants.UnityAdsName
  override val token = appToken
  lazy val params = s""" appToken: "$appToken" sid: "$sid" oid: "$oid" hmac: "$hmac" """
  ...
  override def generatedVerification: String = {
    ...
    val verifierString = s"oid=$oid,sid=$sid"
